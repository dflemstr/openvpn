...
static const char usage_message[] =
  ...
  "--connect-retry n : For --proto tcp-client or sctp-client, number of seconds to wait\n"
  "                    between connection retries (default=%d).\n"
  "--connect-timeout n : For --proto tcp-client or sctp-client, connection timeout (in seconds).\n"
  ...
  "--port port     : TCP/UDP/SCTP port # for both local and remote.\n"
  "--lport port    : TCP/UDP/SCTP port # for local (default=%d). Implies --bind.\n"
  "--rport port    : TCP/UDP/SCTP port # for remote (default=%d).\n"
  "--bind          : Bind to local address and port. (This is the default unless\n"
  "                  --proto tcp-client/sctp-client"
#ifdef ENABLE_HTTP_PROXY
                   " or --http-proxy"
#endif
#ifdef ENABLE_SOCKS
  ...
  "                  remote address.\n"
  "--ping n        : Ping remote once every n seconds over TCP/UDP/SCTP port.\n"
#if ENABLE_IP_PKTINFO
  ...
  "                  TCP/UDP/SCTP MTU from it (default=%d).\n"
  "--tun-mtu-extra n : Assume that tun/tap device might return as many\n"
  "                  as n bytes more than the tun-mtu size on read\n"
  "                  (default TUN=0 TAP=%d).\n"
  "--link-mtu n    : Take the TCP/UDP/SCTP device MTU to be n and derive the tun MTU\n"
  "                  from it.\n"
  "--mtu-disc type : Should we do Path MTU discovery on TCP/UDP/SCTP channel?\n"
  ...
  "--sndbuf size   : Set the TCP/UDP/SCTP send buffer size.\n"
  "--rcvbuf size   : Set the TCP/UDP/SCTP receive buffer size.\n"
  ...
  "                  until after TCP/UDP/SCTP connection establishment with peer.\n"
  ...
  "                       and received from TCP/UDP/SCTP (caps) or tun/tap (lc)\n"
